...
const SiriOrb: React.FC<SiriOrbProps> = ({
  ...
  const defaultColors = {
  bg: "oklch(96% 0.01 250)",   // very light cool background
  c1: "oklch(68% 0.12 240)",   // soft primary blue
  c2: "oklch(72% 0.10 230)",   // lighter blue
  c3: "oklch(65% 0.08 220)",   // muted blue-cyan
};
